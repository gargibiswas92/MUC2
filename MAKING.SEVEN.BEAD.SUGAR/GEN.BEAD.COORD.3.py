...
#dis1 is the distance between new sugar (sugar(i)) and sugar(i-2)
#ang1 is the angle between sugar(i), sugar(i-1) and sugar(i-2)
#ang2 is the angle between sugar(i), sugar(i-2) and prot(ii)
...
for lines2 in infile2:
    arr = lines2.split()
    sugar2_ind.append(int(arr[0]))
    sugar1_ind.append(int(arr[1]))
    prot_ind.append(int(arr[2]))
    counta = counta + 1
