...
fix_tails = np.concatenate((tail_d, tail_b, tail_c, tail_dd, tail_a, tail_aa, tail_cc))
...
group_b = [tail_bb1, tail_bb2, tail_bb3, tail_bb4, tail_bb5]
name_b = ['tail_bb1', 'tail_bb2', 'tail_bb3', 'tail_bb4', 'tail_bb5'] 
