...
##*****************writing bond, defination, dihedrals and other outputs*******************************************##
    if flag == 0:
        ...
        flg = select_charge(count)
        if flg == 0:
        
           ss1 = 'HETATM {:>5d}  C1 0VB {:>5d} {:>10.2f} {:>7.2f} {:>7.2f}{}'.format(ind, ind, x1, y1, z1, "\n")
           out1.writelines(ss1)
           ss2 = '{:>5d}0VB     C1{:>5d} {:>7.3f} {:>7.3f} {:>7.3f}{}'.format(ind, ind, x1, y1, z1, "\n")
           out2.writelines(ss2)
           ss3 = ' {:>5d}       NB_3  {:>5d}    0VB     C1  {:>5d}{}'.format(ind, ind, ind, "\n")
           out3.writelines(ss3)
           ss4 = '{:>5d}   {:>5s}   1        6.987500432e-01 2.000000000e+04{}'.format(ind, str(ss), "\n")
           out4.writelines(ss4)
        ...
        if flg == 1:
           ...
           ss1 = 'HETATM {:>5d}  C1 0VA {:>5d} {:>10.2f} {:>7.2f} {:>7.2f}{}'.format(ind, ind, x1, y1, z1, "\n")
           out1.writelines(ss1)
