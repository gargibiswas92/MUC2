...
for k in range(count_prot_s):
    ...
    xs4, ys4, zs4 = solve_coordinates(x2, y2, z2, x3, y3, z3, x33, y33, z33, 115.5, 90.9, 2.11)
    xs5, ys5, zs5 = solve_coordinates(x2, y2, z2, x3, y3, z3, x33, y33, z33, 115.5, 90.9, 2.59)
        ...
        if val1 == 0 and val2 == 0 and val3 == 0 and val4 == 0 and val5 ==0 and val6 == 0:
           ...
           if len(x_sol) > 6:
               ...
               if ds == 0:
                   ...
                   write_output(outfile1, outfile2, outfile3, outfile4, outfile5, outfile6, ind+4, ind+3, ind+2, ind+1, xs4, ys4, zs4)
                   write_output2(outfile1, outfile2, outfile3, outfile4, outfile5, outfile6, ind+5, ind+4, ind+3, ind+2, xs5, ys5, zs5)
